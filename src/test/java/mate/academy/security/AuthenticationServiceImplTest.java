...
class AuthenticationServiceImplTest {
    ...
    void login_Ok() throws AuthenticationException {
        ...
        Mockito.when(passwordEncoder.matches(admin.getPassword(), admin.getPassword())).thenReturn(true);
        User actual = authenticationService.login(admin.getEmail(), admin.getPassword());
        Contracts.assertNotNull(actual);
        assertEquals(admin, actual);
    }
    @Test
    void login_Not_Ok() throws AuthenticationException {
        ...
        assertThrows(AuthenticationException.class,
                () -> authenticationService.login(admin.getEmail(), "1234"));
    }
}
