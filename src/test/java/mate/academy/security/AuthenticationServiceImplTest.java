...
class AuthenticationServiceImplTest {
    ...
    private static final String INCORRECT_PASSWORD = "user123";
    ...
    @Test
    void login_isSuccessful_ok() throws AuthenticationException {
    ...
    @Test
    void login_passwordIsNotMatches_notOk() {
        Mockito.when(userService.findByEmail(EMAIL)).thenReturn(Optional.of(user));
