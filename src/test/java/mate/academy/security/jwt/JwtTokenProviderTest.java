...
class JwtTokenProviderTest {
    ...
    private static final String TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJib2JAaS51YSIsInJvbGVzIjpb"
            + "IlVTRVIiXSwiaWF0IjoxNjUwMzAwNTY2LCJleHAiOjE2NTAzMDQxNjZ9.RaRoAabxKI0_nyfbDHIXpGf7mB"
            + "Ot0ZMmAAyYtzpRd98";
    ...
    void resolveToken_ok() {
        ...
        String token = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJib2JAaS51YSIsInJvbGVzIjpb"
                + "IlVTRVIiXSwiaWF0IjoxNjUwMzAwNTY2LCJleHAiOjE2NTAzMDQxNjZ9.RaRoAabxKI0_nyfbDHIXpGf7mB"
                + "Ot0ZMmAAyYtzpRd98";
