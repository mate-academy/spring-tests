...
class JwtTokenProviderTest {
    ...
    void createToken_validInput_ok() {
        ...
        Assertions.assertEquals(expected, actual,
                "It should create valid token for login %s, roles %s and time %s\n"
    ...
    void resolveToken_validInput_ok() {
        ...
        Assertions.assertEquals(expected, actual,
                "It should return %s for request with Authorization header: %s\n"
    ...
    void resolveToken_nullBearerToken_ok() {
        ...
        Assertions.assertNull(actual,
                "It should return null for request with Authorization header: null\n");
    }
    ...
    void validateToken_validToken_ok() {
        ...
        Assertions.assertTrue(actual,
                "It should return true for valid token created at: %s and validity: %s\n"
    ...
    void validateToken_expiredToken_notOk() {
        ...
        Assertions.assertThrows(
                ...
                "It should throw RuntimeException for token created at: %s and validity: %s\n"
                        .formatted(now, validityInMilliseconds));
    }
    ...
    void validateToken_invalidToken_notOk() {
        ...
        Assertions.assertThrows(
                RuntimeException.class,
                () -> jwtTokenProvider.validateToken(token),
                "It should throw RuntimeException for invalid token: " + token);
    }
