...
class JwtTokenProviderTest {
    private static final String TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbkBtYWlsLm5ldCIsInJvbGVzIjpbIlVTRVIiXSwiaWF0IjoxNjU2NjE1MTUxLCJleHAiOjE2NTY5NzUxNTF9.5Y7akQEvQrdaZJGZyAnkmBTeARTmRD3GDxi8HK6DofA";
    ...
    void resolveToken_Ok() {
        ...
        Mockito.when(httpServletRequest.getHeader("Authorization")).thenReturn("Bearer tokien_body");
