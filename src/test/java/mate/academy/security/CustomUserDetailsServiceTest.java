...
class CustomUserDetailsServiceTest {
    ...
    void loadUserByUsername_OK() {
        ...
        vitalii.setRoles(Set.of(new Role(Role.RoleName.USER)));
        Mockito.when(userService.findByEmail(any())).thenReturn(Optional.of(vitalii));
    ...
    void loadUserByUsername_exception() {
        ...
        String email = "vitalii@gmail.com";
        vitalii.setEmail(email);
        vitalii.setPassword("1234");
        vitalii.setRoles(Set.of(new Role(Role.RoleName.USER)));
        Mockito.when(userService.findByEmail(email)).thenReturn(Optional.of(vitalii));
        try {
