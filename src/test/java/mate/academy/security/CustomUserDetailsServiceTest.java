...
class CustomUserDetailsServiceTest {
    ...
    void loadUserByUsername_validEmail_ok() {
        ...
        Assertions.assertEquals(email, userDetails.getUsername(),
                "It should return userDetails with userName matching email passed\n");
        Assertions.assertEquals(password, userDetails.getPassword(),
                "It should return userDetails with password matching password passed\n");
        ...
        Assertions.assertEquals(expectedRole, actualRole,
                "It should return userDetails with authority matching role of user\n");
    }
    ...
    void loadUserByUsername_invalidEmail_notOk() {
        ...
        Assertions.assertThrows(UsernameNotFoundException.class,
                ...
                "It should throw %s when invalid email is passed"
