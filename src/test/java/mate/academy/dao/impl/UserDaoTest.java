...
class UserDaoTest extends AbstractTest {
    ...
    void findByEmail_notExistingEmail_notOk() {
        Optional<User> actual = userDao.findByEmail("valid@i.ua");
        Assertions.assertNotNull(actual);
    ...
    void findById_existingId_ok() {
        ...
        Assertions.assertEquals("valid@i.ua", actual.get().getEmail());
        Assertions.assertEquals("1234", actual.get().getPassword());
    }
