...
class RoleServiceImplTest {
    ...
    void getRoleByName_Ok(){
        Mockito.when(roleDao.getRoleByName(ROLE_NAME_ADMIN)).thenReturn(Optional.of(ROLE_CLASS_ADMIN));
    ...
    void getRoleByName_Causes_Exception_Not_Ok(){
        ...
        assertThrows(DataProcessingException.class, () -> roleService.getRoleByName(ROLE_NAME_ADMIN));
    }
}
