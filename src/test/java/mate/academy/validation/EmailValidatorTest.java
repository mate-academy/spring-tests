...
class EmailValidatorTest {
    ...
    void isValid_validEmail_Ok() {
        Assertions.assertTrue(emailValidator.isValid("bob@mail.com",
    ...
    void isValid_invalidEmail_NotOk() {
        ...
        Assertions.assertFalse(emailValidator.isValid("bob bob@ma il.co m",
                constraintValidatorContext));
        Assertions.assertFalse(emailValidator.isValid("@mail.com",
                constraintValidatorContext));
        Assertions.assertFalse(emailValidator.isValid("bob@.com",
                constraintValidatorContext));
        Assertions.assertFalse(emailValidator.isValid("bob@mail.",
                constraintValidatorContext));
    }
