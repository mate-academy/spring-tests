...
class EmailValidatorTest {
    ...
    public void isValid_invalidEmail_ok() {
        ...
        invalidEmails.add("mail.com");
        invalidEmails.add("test.mail.com");
        invalidEmails.add("test@mail");
        invalidEmails.add("test@mail.x");
        invalidEmails.add("test@mail@another.one");
        invalidEmails.add("test@mail.#$%");
        invalidEmails.add("test@%^&*.com");
        invalidEmails.forEach(email -> {
            boolean actual = emailValidator.isValid(email, context);
            Assertions.assertFalse(actual,
                    "It should return false for email %s\n"
                            .formatted(email));
        });
    }
